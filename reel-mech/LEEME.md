# Sarier · reel "Mech interp (guion 10)"

Composición HyperFrames construida sobre `../reelkit.py` (motor común: subtítulos cinéticos, statements blancos por capas,
gráficos de línea en zona segura de Instagram, escenas faceless cortas, fundido final). Original subido como release `reel-6`.
